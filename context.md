...
## Overview
A marketing website for **E-Perfect Beauty** (E Perfect Eyebrow Studio), a Singapore-based beauty studio specializing in natural-looking embroidery and facial care. The site features a glassmorphic/neumorphic design, an interactive hero section with auto-rotating service pills, and a hardcoded blog.
...
- **Blog:** Hardcoded posts in `js/blog-posts.js`, rendered on `blog.html`.
...
- **Backend:** None — static site; blog posts are edited in `js/blog-posts.js`.
